...
*/
    ...
    gsapWithCSS.fromTo(".action-header", {
        y: -20,
        opacity: 0
    }, {
        y: 0,
    ...
    requestAnimationFrame((() => {
        gsapWithCSS.from(".title-main .char", 1, {
            opacity: 0,
            delay: 1.2,
            yPercent: 70,
            stagger: .07,
        ...
        gsapWithCSS.utils.toArray(".subtext").forEach((subtext => {
        ...
        const gsapItem = gsapWithCSS.utils.toArray(".subtext-main");
    ...
    gsapWithCSS.from(".performance__button", {
        scrollTrigger: {
    ...
    gsapWithCSS.from(".bottom-episodes__button", {
        scrollTrigger: {
    ...
    gsapWithCSS.utils.toArray(".infinite-scroll__row").forEach((row => {
    ...
    const supportedAppAnimation = gsapWithCSS.timeline({
        scrollTrigger: {
    ...
    gsapWithCSS.registerPlugin(ScrollTrigger_ScrollTrigger);
    gsapWithCSS.utils.toArray(".inspiration-pulse__item").forEach((item => {
    ...
    gsapWithCSS.from(".quote__bottom", {
        y: 30,
        opacity: 0,
        duration: .7,
        delay: .3,
    ...
    gsapWithCSS.from(".quote__decoration", {
        scale: 0,
        opacity: 0,
        duration: 1,
        stagger: .2,
    ...
    const slides = document.querySelectorAll(".bottom__slide");
    ...
    function animateBenefits() {
        const items = gsapWithCSS.utils.toArray(".column__item");
    ...
    gsapWithCSS.from(".bottom-benefits__button", {
        scrollTrigger: {
    ...
    animateEpisodes();
    gsapWithCSS.registerPlugin(ScrollTrigger_ScrollTrigger);
    gsapWithCSS.utils.toArray(".column-price__box").forEach((box => {
        gsapWithCSS.from(box.querySelector(".top-plan__lable"), {
            opacity: 0,
            y: -20,
            duration: .5,
            scrollTrigger: {
        ...
        gsapWithCSS.from(box.querySelector(".top-plan__description"), {
            opacity: 0,
            y: -20,
            duration: .5,
            delay: .2,
        ...
        gsapWithCSS.from(box.querySelector(".top-plan__price"), {
            opacity: 0,
            y: -20,
            duration: .5,
            delay: .4,
        ...
        gsapWithCSS.from(box.querySelectorAll(".include__item"), {
            opacity: 0,
            y: -20,
            duration: .5,
            stagger: .1,
    ...
    gsapWithCSS.registerPlugin(ScrollTrigger_ScrollTrigger);
    gsapWithCSS.utils.toArray(".news-column__box").forEach(((box, i) => {
        gsapWithCSS.fromTo(box, {
            opacity: 0,
            y: 20
        }, {
            opacity: 1,
    ...
    gsapWithCSS.fromTo(".link-dowload__button", {
        scale: .9
    }, {
        scale: 1.1,
        duration: 1,
